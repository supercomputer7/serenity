...
ErrorOr<void> VirtualScreenBackend::set_head_mode_setting(GPUConnectorModeSetting mode_setting)
{
...
ErrorOr<GPUConnectorModeSetting> VirtualScreenBackend::get_head_mode_setting()
{
    return GPUConnectorModeSetting {
