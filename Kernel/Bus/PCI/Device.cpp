...
ErrorOr<NonnullRefPtr<Device>> Device::from_enumerable_identifier(HostController& host_controller, EnumerableDeviceIdentifier const& identifier)
{
    return adopt_nonnull_ref_or_enomem(new (nothrow) Device(host_controller, identifier));
}

ErrorOr<NonnullRefPtr<Device>> Device::from_host_bridge_identifier(EnumerableDeviceIdentifier const& identifier)
{
    return adopt_nonnull_ref_or_enomem(new (nothrow) Device(identifier));
}

Device::Device(HostController& host_controller, EnumerableDeviceIdentifier const& identifier)
...
u8 Device::config_space_read8_locked(PCI::RegisterOffset field)
{
    ...
    VERIFY(m_host_controller.has_value());
    ...
    return m_host_controller.value().read8_field(bus_number, device_number, function_number, static_cast<u32>(field));
}
...
u16 Device::config_space_read16_locked(PCI::RegisterOffset field)
{
    ...
    auto device_number = device_address.device();
    auto function_number = device_address.function();
    return m_host_controller.value().read16_field(bus_number, device_number, function_number, static_cast<u32>(field));
}
...
u32 Device::config_space_read32_locked(PCI::RegisterOffset field)
{
    ...
    auto device_number = device_address.device();
    auto function_number = device_address.function();
    return m_host_controller.value().read32_field(bus_number, device_number, function_number, static_cast<u32>(field));
}
...
void Device::config_space_write8_locked(PCI::RegisterOffset field, u8 value)
{
    ...
    auto device_number = device_address.device();
    auto function_number = device_address.function();
    m_host_controller.value().write8_field(bus_number, device_number, function_number, static_cast<u32>(field), value);
}
...
void Device::config_space_write16_locked(PCI::RegisterOffset field, u16 value)
{
    ...
    auto device_number = device_address.device();
    auto function_number = device_address.function();
    m_host_controller.value().write16_field(bus_number, device_number, function_number, static_cast<u32>(field), value);
}
...
void Device::config_space_write32_locked(PCI::RegisterOffset field, u32 value)
{
    ...
    auto device_number = device_address.device();
    auto function_number = device_address.function();
    m_host_controller.value().write32_field(bus_number, device_number, function_number, static_cast<u32>(field), value);
}
