...
class VirtIORNGDriver : public PCI::Driver {
public:
    static void init();
...
static HardwareIDMatch __matches[] = {
    // QEMU VirtIO RNG device
    {
        .class_code = Optional<ClassCode> {},
        ...
        .subsystem_id = Optional<SubsystemID> {},
        .subsystem_vendor_id = Optional<SubsystemVendorID> {},
    },
}

Span<HardwareIDMatch const>
VirtIORNGDriver::matches()
{
    return __matches;
}
...
void VirtIORNGDriver::init()
{
    ...
    PCI::Access::register_driver(driver);
}
