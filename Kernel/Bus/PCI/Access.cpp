...
static Singleton<SpinlockProtected<HashMap<u32, NonnullRefPtr<PCI::HostController>>, LockRank::None>> s_host_controllers;
static Singleton<SpinlockProtected<IntrusiveList<&Driver::m_list_node>, LockRank::None>> s_all_drivers;

SetOnce g_pci_access_io_probe_failed;
SetOnce g_pci_access_is_disabled_from_commandline;

bool is_hardware_disabled()
{
