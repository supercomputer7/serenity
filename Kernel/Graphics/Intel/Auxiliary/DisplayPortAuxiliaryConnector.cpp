...
{
    auto registers_mapping = TRY(Memory::map_typed<volatile UnifiedDisplayPortAuxChannelRegisters>(display_port_auxiliary_start_address, sizeof(UnifiedDisplayPortAuxChannelRegisters), Memory::Region::Access::ReadWrite));
    return adopt_nonnull_own_or_enomem(new (nothrow) DisplayPortAuxiliaryConnector(move(registers_mapping)));
}

DisplayPortAuxiliaryConnector::DisplayPortAuxiliaryConnector(Memory::TypedMapping<volatile UnifiedDisplayPortAuxChannelRegisters> all_display_port_aux_registers)
