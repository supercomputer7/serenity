...
private:
    explicit DisplayPortAuxiliaryConnector(Memory::TypedMapping<volatile UnifiedDisplayPortAuxChannelRegisters>);
    ...
    Memory::TypedMapping<volatile UnifiedDisplayPortAuxChannelRegisters> m_all_display_port_aux_registers;
};
}
