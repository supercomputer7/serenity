...
public:
    static NonnullRefPtr<IntelNativeDisplayConnector> must_create(IntelDisplayConnectorGroup const&, Type, PhysicalAddress framebuffer_address, size_t framebuffer_resource_size);
