...
ErrorOr<void> IntelDisplayConnectorGroup::initialize_gen4_connectors()
{
    ...
    m_transcoders[0] = MUST(IntelCRTDisplayTranscoder::create_with_physical_addresses(transcoder_registers_paddr, dpll_registers_paddr, dpll_control_registers_paddr));
