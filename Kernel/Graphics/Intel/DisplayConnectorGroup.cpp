...
ErrorOr<void> IntelDisplayConnectorGroup::initialize_gen4_connectors()
{
    ...
    auto connector = IntelNativeDisplayConnector::must_create(*this, IntelNativeDisplayConnector::Type::Analog, m_mmio_second_region.pci_bar_paddr, m_mmio_second_region.pci_bar_space_length);
