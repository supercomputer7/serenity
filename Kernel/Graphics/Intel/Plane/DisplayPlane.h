...
public:
    ...
    ErrorOr<void> set_aperture_base(Badge<IntelDisplayConnectorGroup>, IntelGraphics::GPUVirtualAddress aperture_start);
...
protected:
    ...
    IntelGraphics::GPUVirtualAddress m_aperture_start {};
