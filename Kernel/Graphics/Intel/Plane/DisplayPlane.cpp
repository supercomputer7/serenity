...
IntelDisplayPlane::IntelDisplayPlane(Memory::TypedMapping<volatile PlaneRegisters> plane_registers_mapping)
...
ErrorOr<void> IntelDisplayPlane::set_aperture_base(Badge<IntelDisplayConnectorGroup>, IntelGraphics::GPUVirtualAddress aperture_start)
{
    SpinlockLocker locker(m_access_lock);
