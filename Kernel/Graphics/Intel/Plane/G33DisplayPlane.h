...
public:
    ...
    virtual ErrorOr<void> set_plane_settings(Badge<IntelDisplayConnectorGroup>, IntelGraphics::GPUVirtualAddress aperture_start, PipeSelect, size_t horizontal_active_pixels_count) override;
