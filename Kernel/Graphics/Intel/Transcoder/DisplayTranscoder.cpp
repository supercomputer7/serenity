...
IntelDisplayTranscoder::IntelDisplayTranscoder(Memory::TypedMapping<volatile TranscoderRegisters> registers_mapping, Memory::TypedMapping<volatile PipeRegisters> pipe_registers_mapping)
