...
private:
    ...
    IntelCRTDisplayTranscoder(Memory::TypedMapping<volatile TranscoderRegisters>, Memory::TypedMapping<volatile PipeRegisters>, Memory::TypedMapping<volatile DPLLRegisters>, Memory::TypedMapping<volatile DPLLControlRegisters>);
    Memory::TypedMapping<volatile DPLLRegisters> m_dpll_registers;
    Memory::TypedMapping<volatile DPLLControlRegisters> m_dpll_control_registers;
};
}
