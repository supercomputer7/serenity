...
private:
    ...
    IntelCRTDisplayTranscoder(Memory::TypedMapping<volatile TranscoderRegisters>, Memory::TypedMapping<volatile DPLLRegisters>, Memory::TypedMapping<volatile DPLLControlRegisters>);
