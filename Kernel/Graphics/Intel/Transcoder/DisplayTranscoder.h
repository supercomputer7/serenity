...
protected:
    ...
    IntelDisplayTranscoder(Memory::TypedMapping<volatile TranscoderRegisters>, Memory::TypedMapping<volatile PipeRegisters>);
    mutable Spinlock m_access_lock;
    ShadowRegisters m_shadow_registers {};
    Memory::TypedMapping<volatile TranscoderRegisters> m_transcoder_registers;
    Memory::TypedMapping<volatile PipeRegisters> m_pipe_registers;
};
}
