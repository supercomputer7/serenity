...
UNMAP_AFTER_INIT VGATextModeConsole::VGATextModeConsole()
    : Console(80, 25)
    , m_vga_window_region(MM.allocate_kernel_region(PhysicalAddress(0xa0000), Memory::page_round_up(0xc0000 - 0xa0000).release_value_but_fixme_should_propagate_errors(), "VGA Display", Memory::Region::Access::ReadWrite).release_value())
